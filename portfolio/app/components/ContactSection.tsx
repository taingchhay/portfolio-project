          ...
          <div className="rounded-2xl border border-border-custom bg-surface p-8">
            ...
            <div className="mb-8 flex flex-col gap-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-text-secondary">hello@example.com</span>
              </div>
              <div className="flex items-center gap-3">
                <svg className="h-5 w-5 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-accent px-6 py-3 text-sm font-semibold text-background transition-colors hover:bg-accent-hover"
            >
